...
export function RequirementsDeleteDialog({
  open,
  onOpenChange,
  currentRow,
  ...
  const handleDelete = async () => {
    ...
    try {
      await deleteRequirement(currentRow.id)
      onOpenChange(false)
      setValue('')
    } catch (error) {
      ...
      desc={
        <div className='space-y-4'>
          <p className='mb-2'>
            ...
            <br />
            This action will permanently remove this requirement from the system. This cannot be undone.
          </p>
